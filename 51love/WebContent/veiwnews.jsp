...
<div class="box03" id="pertagContent0" style="display:block">
    ...
    <table width="633" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td colspan="3">交友意向：<span class="huangse"><%=jyyx%></span></td>
        </tr>

        <tr>
            <td style="width:300px;">性别：<span><%=sex%></span></td>
            <td style="width:200px;">年龄：<span><%=age%></span></td>
            <td>婚否：<span><%=hyzk%></span></td>
        </tr>

        <tr>
            <td>住址：<span><%=zz+(hyInfo.getS3() == null ? "":hyInfo.getS3())%></span></td>
            <td>职业：<span><%=zy%></span></td>
            <td>学历：<span><%=whcd%></span></td>
        </tr>
        <tr>
            <td>年薪：<span><%=yx%></span></td>
            <td>住房：<span><%=zf%></span></td>
            <td>身高：<span><%=sg%></span></td>
        </tr>
        <tr>
            <td style="border-bottom:0">体重：<span><%=tz%>斤</span></td>
            <td style="border-bottom:0">星座：<span><%=xz%></span></td>
            <td style="border-bottom:0">血型：<span><%=xx%></span></td>
        </tr>
    </table>
    <div class="lm_name">
        <h2><%=hyInfo.getSex().equals("11")?"她":"他" %>的补充资料：</h2>
    </div>
    <div class="txt"> 性格特征：<%=xgtz%> </div>
    <div class="txt"> 情爱关系：<%=uother.getQggx()%> </div>
    <div class="txt"> 理想情人：<%=uother.getLxqr()%> </div>
    <div class="lm_name">
        <h2><%=hyInfo.getSex().equals("11")?"她":"他" %>的交友宣言：</h2>
    </div>
    <div class="txt"><%=uother == null ? "":uother.getJyly()%></div>
</div>
...
<div class="box03" id="pertagContent2" style="display:none">
    <div class="tit02">
        <h1><%=loginUser!=null?loginUser.getLcname():"XXX"%></h1>的文集
    </div>
    <div class="TextShow">

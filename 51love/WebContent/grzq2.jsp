...
function test()
{
    ...
    if (checkspace(document.personal.csdate2.value)){
        alert('请选择您的出生日期！');
        document.personal.csdate2.focus();
        return false;
    }
    var dtEnd = new Date();
    var dtStart = document.personal.csdate2.value.substr(0,4);
...
function checkspace(checkstr) {
   ...
   function zuheYMD(){
       document.personal.csdate2.value=  document.personal.year.value+"-"+document.personal.month.value+"-"+document.personal.day.value;
   }
...
<%
    ...
    if(loginUser == null)
    {
        out.println("<script language='javascript'>alert('您是游客，您的权限不够，请先注册　　');showLogin('index.jsp','grzq.jsp');</script>");
        return;
    }else{
        String vurl="";
...
<div class="wrapper1250 cm_block01">
  ...
  <div class="box01"> <span class="tx">
     ...
     <%
          String lcname = "";
         System.out.println("-------aaaaaaaaaaaaaaaaa------"+grwhqUser);
         if(grwhqUser!=null){
             lcname =  grwhqUser.getLcname();
         }
      %>
      <p class="zl"><strong><%=lcname%></strong></p>
      <div class="lm_name">
          <h2>个人操作专区</h2>
      </div>
    ...
    <div class="box02">
      ...
      <form name="personal" method="post" action="userinfoupdate.jsp" onSubmit="return test()" target="sframe">
<table border="0" align="center" cellpadding="4" cellspacing="0" class="reg_tab02">
              ...
              <%  System.out.println("-------00000000000------");%>
                ...
                <tr>
                  ...
                  <td bgcolor="#FFFFFF" class="bk04">
                      ...
                      <input name="s3" type="text" class="input02" id="s3" value="<%=loginUser.getS3() == null ? "县区":loginUser.getS3()%>" size="12" maxlength="5"/>
                    </td>
                </tr>
                <tr>
                  <td align="right" bgcolor="#D6E6F3" class="bk04"><strong>生 日：</strong></td>

                    <input name="csdate2" type="hidden" id="csdate" value="<%=DateTools.dateToString(loginUser.getCsdate(),false)%>"/>
                  <td bgcolor="#FFFFFF" class="bk04"><select name="year" onchange="zuheYMD()">
                      <%
                          String year_month_day = DateTools.dateToString(loginUser.getCsdate(),false);
                          String year = "";
                          String month = "";
                          String day = "";
                ...
                <tr>
                  ...
                  <td bgcolor="#FFFFFF" class="bk04">  <%
                      String o = loginUser.getWhcd().toString();
                      if(o.equals(11)){
                          o = "12";
                      }else{
                          o = loginUser.getWhcd();
             ...
             <table border="0" align="center" cellpadding="4" cellspacing="0" class="reg_tab02" width="100%" style="margin-top:5px;">
                ...
                <tr>
                  ...
                  <td bgcolor="#FFFFFF" class="bk04">(请正确填写，以便其他会员与您联系。)</td>
                </tr>
                <tr>
                  ...
                  <td bgcolor="#FFFFFF" class="bk04">
                      ...
                      <%
                          if (loginUser.getVacsjtel()== 1 && loginUser.getIsvcation() == 1 ){
                      %>
                      <strong><%=loginUser.getSjtel() == null ? "" : loginUser.getSjtel()%></strong>
                      <span style="background-color:#090; height:20px;margin-left:10px;
                color:#FFF">已验证</span> &nbsp;
                      <input type="button" class="button1" onClick="window.location.href='grsjyz.jsp';" value="重新验证" />
                      <%
                          }else{
                      %>
            ...
            <div class="MyBtn">
                    <input name="bsendsms" type="button" id="bsendsms" onclick="javascript:window.location.href='perinfo.jsp?id=<%=loginUser.getHyid()%>';" value="显示个人主页" class="btn">
               &nbsp; <input name="bsendsms" type="submit" value="确 认 修 改" class="btn">
            </div>
  </form>
    </div>
    <div style="clear:both"></div>

...
<%
//说明:仅供测试使用，及时删除，just for test used, add by linyu at 20151130
...
<div class="wrapper1250 cm_block01">
  <iframe id="visitFrame" name="visitFrame" width="0" height="0" frameborder="0" src="visitForPay_type.jsp" ></iframe>
  <div class="block02">
      <div class="lm_name02">
      <h2>51交友中心网上支付系统</h2>
    </div>
    <form action="pay_do_bjd.jsp" id="payform" name="payform" method="post" target="_blank">
       <div class="TabBox">
          ...
          <tr>
            ...
            <td>
               ...
               <tr>
                   <td align="right"></td>
                   <td valign="middle" height="50">
                       <input type="radio" disabled="disabled" name="paymode" value="4" style="vertical-align:middle;"><img src="images/wechart.jpg" style="vertical-align:middle;">（开发中）
                   </td>
               </tr>
        </table>
        <div class="MyBtn">

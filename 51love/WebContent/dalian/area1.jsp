...
Userinfo loginUser = (Userinfo)session.getAttribute(SysDefine.SESSION_LOGINNAME);
  ...
  if(address1.length() ==0){
   ...
   ///得到用户列表
   String sql = "from Userinfo as o where o.isdel = 0 and o.isvcation = 0 ";
   ...
   String jyzt = LoverTools.getJYZTDes(temp);
    ...
    if(j%2 == 0 && j>0)
           ...
           <a href="../perinfo-id-<%=temp.getHyid()%>.htm" target="_blank" class="new_link06"><img src="../<%=afilepathsmall+File.separator+userother.getUserphoto1() %>" width="90" height="120" /></a>
                       ...
                       %></td>
                            ...
                            <strong><font color="#41a4e3"><%=temp.getLcname() %></font></strong></a><%if(isvery) {%> - <img src="images/yyz.gif" width="14" height="13" /><font color="#FF0000">已验证</font><%} %><br />
                              <font color="#ff7878"><strong><%=temp.getSex().equals("11") ? "女" : "男" %></strong></font>
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%= age %>岁&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=vhyzk %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=vs1 %><br />
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#e7f0fa">
        <tr>
          <td align="center" height="50px"><form name="go2to" method="post" action="area1.jsp">
...
{
  out.println("<a href='area1-cpages-1-sex-"+sex+"-address-"+address+"-himg-"+himg+"-hyzk-"+hyzk+"-yx-"+yx+"-jyyx-"+jyyx+"-tcounts-"+qr.rowCount+".htm'>首 页</a>&nbsp;&nbsp;<a href='area1-cpages-"+prepage+"-sex-"+sex+"-address-"+address+"-himg-"+himg+"-hyzk-"+hyzk+"-yx-"+yx+"-jyyx-"+jyyx+"-tcounts-"+qr.rowCount+".htm'>上一页</a>&nbsp;&nbsp;");
}

for(int i =startpage;i < startpage+10; i ++)
{
  if(i < totalPage && i != cpage)
     out.println("<a href='area1-cpages-"+i+"-sex-"+sex+"-address-"+address+"-himg-"+himg+"-hyzk-"+hyzk+"-yx-"+yx+"-jyyx-"+jyyx+"-tcounts-"+qr.rowCount+".htm'>"+i+"</a>&nbsp;&nbsp;");
  else if(i == cpage)
...
{
  out.println("<a href='area1-cpages-"+nextpage+"-sex-"+sex+"-address-"+address+"-himg-"+himg+"-hyzk-"+hyzk+"-yx-"+yx+"-jyyx-"+jyyx+"-tcounts-"+qr.rowCount+".htm'>下一页</a>&nbsp;&nbsp;<a href='area1-cpages-"+totalPage+"-sex-"+sex+"-address-"+address+"-himg-"+himg+"-hyzk-"+hyzk+"-yx-"+yx+"-jyyx-"+jyyx+"-tcounts-"+qr.rowCount+".htm'>尾页</a>&nbsp;&nbsp;");
}
%>
        ...
        <tr>
          <td width="160" height="110"><table width="130" border="0" align="center" cellpadding="0" cellspacing="0">
            <tbody>
              ...
              <tr>
                <td align="left"><ul>
                  <li <%=himg.equals("0")  ? "style=\"background:#0099CC\"":""%>><a href="area1-address-<%=address+"-as2-"+s2+"-sex-"+sex+"-jyyx-"+jyyx+"-himg-0-hyzk-"+hyzk+"-yx-"+yx%>.htm" <%=himg.equals("0") ? "style=\"color: #FFFFFF\"":""%>>不限</a></li>
                  <li <%=himg.equals("1") ? "style=\"background:#0099CC\"":""%>><a href="area1-address-<%=address+"-as2-"+s2+"-sex-"+sex+"-jyyx-"+jyyx+"-himg-1-hyzk-"+hyzk+"-yx-"+yx%>.htm" <%=himg.equals("1") ? "style=\"color: #FFFFFF\"":""%>>有</a></li>
                  <li <%=himg.equals("2") ? "style=\"background:#0099CC\"":""%>><a href="area1-address-<%=address+"-as2-"+s2+"-sex-"+sex+"-jyyx-"+jyyx+"-himg-2-hyzk-"+hyzk+"-yx-"+yx%>.htm" <%=himg.equals("2") ? "style=\"color: #FFFFFF\"":""%>>无</a></li>
                </ul></td>
              </tr>
              <tr>
              ...
              <tr>
                <td align="left"><ul>
                  <li <%=sex.equals("0")  ? "style=\"background:#0099CC\"":""%>><a href="area1-address-<%=address+"-sex-"+"0"+"-jyyx-"+jyyx+"-himg-"+himg+"-hyzk-"+hyzk+"-yx-"+yx%>.htm" <%=sex.equals("0") ? "style=\"color: #FFFFFF\"":""%>>不限</a></li>
                  <li <%=sex.equals("10") ? "style=\"background:#0099CC\"":""%>><a href="area1-address-<%=address+"-sex-"+"10"+"-jyyx-"+jyyx+"-himg-"+himg+"-hyzk-"+hyzk+"-yx-"+yx%>.htm" <%=sex.equals("10") ? "style=\"color: #FFFFFF\"":""%>>帅哥</a></li>
                  <li <%=sex.equals("11") ? "style=\"background:#0099CC\"":""%>><a href="area1-address-<%=address+"-sex-"+"11"+"-jyyx-"+jyyx+"-himg-"+himg+"-hyzk-"+hyzk+"-yx-"+yx%>.htm" <%=sex.equals("11") ? "style=\"color: #FFFFFF\"":""%>>美女</a></li>
                </ul></td>
              </tr>
              <tr>
              ...
              <tr>
                <td align="left"><ul>
                  <li <%=hyzk.equals("0")  ? "style=\"background:#0099CC\"":""%>><a href="area1-address-<%=address+"-sex-"+sex+"-jyyx-"+jyyx+"-himg-"+himg+"-hyzk-"+"0"+"-yx-"+yx%>.htm" <%=hyzk.equals("0") ? "style=\"color: #FFFFFF\"":""%>>不限</a></li>
                  <li <%=hyzk.equals("10") ? "style=\"background:#0099CC\"":""%>><a href="area1-address-<%=address+"-sex-"+sex+"-jyyx-"+jyyx+"-himg-"+himg+"-hyzk-"+"10"+"-yx-"+yx%>.htm"  <%=hyzk.equals("10") ? "style=\"color: #FFFFFF\"":""%>>未婚</a></li>
                  <li <%=hyzk.equals("12") ? "style=\"background:#0099CC\"":""%>><a href="area1-address-<%=address+"-sex-"+sex+"-jyyx-"+jyyx+"-himg-"+himg+"-hyzk-"+"12"+"-yx-"+yx%>.htm"  <%=hyzk.equals("12") ? "style=\"color: #FFFFFF\"":""%>>单身</a></li>
                  <li <%=hyzk.equals("11") ? "style=\"background:#0099CC\"":""%>><a href="area1-address-<%=address+"-sex-"+sex+"-jyyx-"+jyyx+"-himg-"+himg+"-hyzk-"+"11"+"-yx-"+yx%>.htm" <%=hyzk.equals("11") ? "style=\"color: #FFFFFF\"":""%>>已婚</a></li>
              ...
              <tr>
                <td align="left"><ul>
                  <li <%=yx.equals("0")  ? "style=\"background:#0099CC\"":""%>><a href="area1-address-<%=address+"-sex-"+sex+"-jyyx-"+jyyx+"-himg-"+himg+"-hyzk-"+hyzk+"-yx-"+"0"%>.htm" <%=yx.equals("0") ? "style=\"color: #FFFFFF\"":""%>>不限</a></li>
                </ul></td>
              </tr>
              <tr>
                <td align="left"><a href="area1-address-<%=address+"-sex-"+sex+"-jyyx-"+jyyx+"-himg-"+himg+"-hyzk-"+hyzk+"-yx-"+"10"%>.htm"   <%=yx.equals("10") ? "style=\"background:#0099CC;color: #FFFFFF\"":""%>>2万元以下</a></td>
              </tr>
              <tr>
                <td align="left"><a href="area1-address-<%=address+"-sex-"+sex+"-jyyx-"+jyyx+"-himg-"+himg+"-hyzk-"+hyzk+"-yx-"+"11"%>.htm"  <%=yx.equals("11") ? "style=\"background:#0099CC;color: #FFFFFF\"":""%>>2-5万元</a></td>
              </tr>
              <tr>
                <td align="left"><a href="area1-address-<%=address+"-sex-"+sex+"-jyyx-"+jyyx+"-himg-"+himg+"-hyzk-"+hyzk+"-yx-"+"12"%>.htm"   <%=yx.equals("12") ? "style=\"background:#0099CC;color: #FFFFFF\"":""%>>5-10万元</a></td>
              </tr>
              <tr>
                <td align="left"><a href="area1-address-<%=address+"-sex-"+sex+"-jyyx-"+jyyx+"-himg-"+himg+"-hyzk-"+hyzk+"-yx-"+"13"%>.htm"   <%=yx.equals("13") ? "style=\"background:#0099CC;color: #FFFFFF\"":""%>>10-100万元 </a></td>
              </tr>
              <tr>
                <td align="left"><a href="area1-address-<%=address+"-sex-"+sex+"-jyyx-"+jyyx+"-himg-"+himg+"-hyzk-"+hyzk+"-yx-"+"14"%>.htm"   <%=yx.equals("14") ? "style=\"background:#0099CC;color: #FFFFFF\"":""%> >100万元以上 </a></td>
              </tr>
              <tr>
              ...
              <tr>
                <td align="left"><ul>
                  <li <%=jyyx.equals("")  ? "style=\"background:#0099CC\"":""%>><a href="area1-address-<%=address+"-sex-"+sex+"-jyyx-"+""+"-himg-"+himg+"-hyzk-"+hyzk+"-yx-"+yx%>.htm" <%=jyyx.equals("") ? "style=\"color: #FFFFFF\"":""%>>不限</a></li>
                </ul></td>
              </tr>
              <tr>
                <td align="left"><a href="area1-address-<%=address+"-sex-"+sex+"-jyyx-"+"1"+"-himg-"+himg+"-hyzk-"+hyzk+"-yx-"+yx%>.htm"   <%=jyyx.equals("1") ? "style=\"background:#0099CC;color: #FFFFFF\"":""%>>纯友谊</a> 
                <a href="area1-address-<%=address+"-sex-"+sex+"-jyyx-"+"2"+"-himg-"+himg+"-hyzk-"+hyzk+"-yx-"+yx%>.htm"  <%=jyyx.equals("2") ? "style=\"background:#0099CC;color: #FFFFFF\"":""%>>异性恋人</a></td>
              </tr>
              <tr>
                <td align="left"><a href="area1-address-<%=address+"-sex-"+sex+"-jyyx-"+"3"+"-himg-"+himg+"-hyzk-"+hyzk+"-yx-"+yx%>.htm"    <%=jyyx.equals("3") ? "style=\"background:#0099CC;color: #FFFFFF\"":""%>>同性恋人</a> 
                <a href="area1-address-<%=address+"-sex-"+sex+"-jyyx-"+"4"+"-himg-"+himg+"-hyzk-"+hyzk+"-yx-"+yx%>.htm"   <%=jyyx.equals("4") ? "style=\"background:#0099CC;color: #FFFFFF\"":""%>>婚姻</a></td>
              </tr>
              <tr>
                <td align="left"><a href="area1-address-<%=address+"-sex-"+sex+"-jyyx-"+"5"+"-himg-"+himg+"-hyzk-"+hyzk+"-yx-"+yx%>.htm"   <%=jyyx.equals("5") ? "style=\"background:#0099CC;color: #FFFFFF\"":""%>>E夜情</a> 
                <a href="area1-address-<%=address+"-sex-"+sex+"-jyyx-"+"6"+"-himg-"+himg+"-hyzk-"+hyzk+"-yx-"+yx%>.htm"  <%=jyyx.equals("6") ? "style=\"background:#0099CC;color: #FFFFFF\"":""%>>陪伴</a></td>
              </tr>
              <tr>
                <td align="left"><a href="area1-address-<%=address+"-sex-"+sex+"-jyyx-"+"7"+"-himg-"+himg+"-hyzk-"+hyzk+"-yx-"+yx%>.htm"   <%=jyyx.equals("7") ? "style=\"background:#0099CC;color: #FFFFFF\"":""%>>其它</a></td>
              </tr>
              <tr>
                <td align="left">&nbsp;</td>
              </tr>

CKEDITOR.dialog.add("UploadPic", function (a) {
    ...
    return { title: '上传图片', minWidth: 390, minHeight: 150, contents: [
        { id: "tab1", label: "", title: "", expand: !0, padding: 0, elements: [
            { type: "jsp", html: "<form action='http://www.51lover.org/ckeditor/plugins/UploadPic/dialogs/upload.jsp' method='post' enctype='multipart/form-data' target='myiframe' style='margin-top:10px;'>" +
                ...
                "<input name='submit' onclick='return check();'  id='sumit' value='上传' type='submit'style='background: #fbfbfb;url(http://static.zcool.com.cn/images/txtBg.png) repeat-x left top;height: 36px; line-height: 36px; text-align:center; margin-top:10px; border: 1px solid #abadb3;font-size: 14px;padding: 0 5px;width:70px;' /></form>" +

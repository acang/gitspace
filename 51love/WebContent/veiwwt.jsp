...
<div class="wrapper1250 cm_block01">
  <div class="block01">
  <div class="lm_name"><h2>使用指南</h2></div>
    <ul>
      <li><a href="veiwwt.jsp?id=1773448"  <% if("1773448".equals(id)){  %> class="current" <%}%>>服务条款</a></li>
	  <li><a href="veiwwt.jsp?id=1773449"  <% if("1773449".equals(id)){  %> class="current" <%}%>>隐私保护</a></li>
      <li><a href="veiwwt.jsp?id=1773450"  <% if("1773450".equals(id)){  %> class="current" <%}%>>交友须知</a></li>

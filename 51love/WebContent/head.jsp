...
<%@ page import="com.web.obj.Checkinfo" %>
<%@ page import="com.lover.mng.CheckinfoMng" %>
<%@ page import="com.web.obj.Readarticle" %>
<%@ page import="com.lover.mng.ReadarticleMng" %>
...
.topbar .tels { float:right; width:215px; height:25px;  }
    ...
    <%
        ...
        if(flag == SysDefine.SYSTEM_HY_TYPE_nvip)
        {
            memberGrade = "VIP";
        }
        
        if("普通会员".equals(memberGrade) && 2==grwhqUser.getIsdel()){
        	memberGrade="待审核";
        }
        ...
        //Long articleid,Long hyid,String lname,String name,Date inserttime,String title,Long gold,Long readnumber
        //test addSharearticle sharearticle
        //Sharearticle sharearticle = new Sharearticle(2L,2L,0L,"testname","testlname",new Date(),"testTitle",29L,29L);
        //SharearticleMng.addSharearticle(sharearticle);
        //Readarticle sharearticle = new Readarticle(2L,2L,"testname","testlname",new Date(),"testTitle","IP");
        //ReadarticleMng.addReadarticle(sharearticle);
        //Long checkerid,Long hyid,Long id,String status,String hyname,String lcname,String checkername,Date time,Date nexttime
        //Checkinfo checkinfo = new Checkinfo(2L,2L,0L,"1","hyname","testTitle","testTitle",new Date(),new Date());
        //CheckinfoMng.addCheckInfo(checkinfo);
        String shsh="-1";
        if(grwhqUser!=null &&grwhqUser.getIsdel()!=null &&grwhqUser.getIsdel()==2){
        	shsh="2";
        }
...
this.setHomePage(document.location.host);event.returnValue=false;"
    class="baise">设为首页</a> | <a
        ...
        %>
        <p><span class="wap"><a href="map.jsp" class="baise">网站地图</a>&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="tels">客服电话：<front style="color:#F3EA0C;font-weight:bold;">025-85519991</front></span></p>
    </div>
</div>
<div class="head_bg">
    ...
    <div class="wrapper1250 nav">
        <ul>
			...
			if(tempLoginUser == null)
			 {
			%>
			<li><a href="javascript:showLogin('index.jsp','grzq.jsp')">个人专区</a></li>
			<%
			 }else{
				 %>
					<li><a href="grzq.jsp">个人专区</a></li>
				<% 
			 }
			%>
			...
			if(tempLoginUser == null)
			 {
			%>
			<li><a href="javascript:showLogin('index.jsp','hyzf.htm')">会员资费</a></li>
			<%
			 }else{
				 %>
					<li><a onclick="return hrefclicektest();" href="hyzf.htm">会员资费</a></li>
				<% 
			 }
			%>

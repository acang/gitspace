...
<div class="cm_block01">
    ...
    <tr>
        <td width="100" align="center" style="background-color:#f2f4f8; height: 30px"><strong>序号</strong></td>
        <td width="150" align="center" style="background-color:#f2f4f8;" ><strong>时间</strong></td>
		<td width="200" align="center" style="background-color:#f2f4f8;" ><strong>分享页面</strong></td>
        <td align="center" style="background-color:#f2f4f8;" ><strong>转发位置</strong></td>
    </tr>
    <%
        //String sql = "select top 300 * from hygl where sqtype=4 and myid='' order by riqi desc, id desc";
        QueryResult qr = GRZQMng.getHYMD(loginUser, SysDefine.SYSTEM_HYGL_SQ, cpage, pagesize);
    ...
    <tr>
        ...
        <td align="center">
            <a href="hymd01.jsp?bizaction=01&id=<%=hygl.getId()%>" class="link10"><img src="images/agree.png"></a>
...
<form id="pageform" name="turn" method="Post" action="hysq.jsp" target="_self">

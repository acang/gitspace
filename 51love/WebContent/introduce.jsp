...
<div class="wrapper1250 cm_block01">
    <div class="block01">
        ...
        <ul>
            <li><a href="introduce.jsp?id=1773446" <% if("1773446".equals(id)){  %> class="current" <%}%>>网站介绍</a></li>
            <li><a href="introduce.jsp?id=1773447" <% if("1773447".equals(id)){  %> class="current" <%}%>>网站证照</a></li>

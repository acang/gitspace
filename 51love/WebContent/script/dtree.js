...
dTree.prototype.o = function(id) {
       if(id == 1)
          window.top.mlist.location.href='addadmin.jsp';
       if(id == 4)
          window.top.mlist.location.href='siteinfo.jsp';
      if(id == 6){
         window.top.mlist.location.href='news_add.jsp';
      }

       if(id == 11)
          window.top.mlist.location.href='friend.jsp';
       if(id == 15)
          window.top.mlist.location.href='kfzxlist.jsp?ntype=0';
       if(id == 23)
          window.top.mlist.location.href='bbs_admin.jsp';
       if(id == 29)
          window.top.mlist.location.href='search.jsp?isdel=0';
       if(id == 40)
           window.top.mlist.location.href='searchhytjtj.jsp';
       if(id == 43)
           window.top.mlist.location.href='advlist.jsp';
       if(id == 46)
           window.top.mlist.location.href='addvip.jsp';
       this.oAll(false);
	var cn = this.aNodes[id];

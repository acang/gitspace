  ...
  <div class="block01">
    ...
    <div class="box02">
      ...
      <div class="tab" id="personTab">
      	  <span class="current" onClick="selectTagHy('pertagContent0',this)" onmouseover="changeClass(this)" onmouseout="recoverClass(this)">总分享金币</span>
          <span onClick="selectTagHy('pertagContent1',this)" onmouseover="changeClass(this)" onmouseout="recoverClass(this)">微信分享办法</span>
          <span onClick="selectTagHy('pertagContent2',this)" onmouseover="changeClass(this)" onmouseout="recoverClass(this)">微信分享金币</span>
		</div>
      <div class="mingdan show" id="pertagContent0">
      	<iframe width="100%" height="670px" src="grjl_fxjb.jsp" name="tgjl_frame" frameborder="0"></iframe>
      </div>
      <div class="mingdan"  id="pertagContent1">
          <iframe width="100%" height="720px" src="grjl_tgjlbf.jsp" name="tgjl_frame" frameborder="0"></iframe>
      </div>
      <div class="mingdan"  id="pertagContent2">
          <iframe width="100%" height="670px" src="grjl_fxqk.jsp" name="tgjl_frame" frameborder="0"></iframe>
      </div>
	</div>
	<div style="clear:both"></div>
  </div>

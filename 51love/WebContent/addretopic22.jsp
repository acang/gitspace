    ...
    <script language="javascript">
        ...
        function addtopicBack(data){
            ...
            obj.innerHTML ="<div class='block01' style='padding:0;'>"+
                    ...
                    "</a></span>"+
                    "<ul><li><strong>回 帖 人：<a href='./perinfo-id-<%//=loginUser.getHyid()%>.htm' target=_blank  style='color: #21648f' ><%//=loginUser.getLcname()%></a>   </strong></li>"+
                    "<li><strong>论坛等级：</strong></li>"+
                    "<li><strong>金　　币：</strong>1111金币</li>"+
                    "<li><strong>加入时间：</strong></li>"+
                    "<li><strong>回 帖 人：<span style='color:#21648f' >222222</span></strong></li>"+
                    "</ul></div>"+
                    "<div class='box02'> "+
                    "<div class='lm_name02'><span style='float:left; font-size:14px'>&nbsp;&nbsp;&nbsp;回复时间：</span></div>"+

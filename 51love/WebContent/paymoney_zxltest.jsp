        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="Tab">
         <tr>
          ...
          <tr>
            ...
            <td>
               <select name="product"   style="height:25px;" >
              ...
              <input name="transamt" size="5" readonly value="1"/>元
            </td>
          </tr>
          <tr>
            ...
            <td>
               ...
               <tr>
                   <td align="right"></td>
                   <td valign="middle" height="50">
                       <input type="radio" name="paymode" value="4" style="vertical-align:middle;">银行汇款（1个工作日升级）
                   </td>
               </tr>
        </table>
        <div class="MyBtn">

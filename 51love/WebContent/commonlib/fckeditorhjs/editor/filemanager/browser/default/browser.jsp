 ...
 *    http://www.mozilla.org/MPL/MPL-1.aboutus.jsp
 *
 * == END LICENSE ==
 *
...
sConnUrl='<%=request.getContextPath()+"/fckeditor/editor/filemanager/browser/default/connectors/jsp/connector"%>'
...
{
	var sUrl = this.ConnectorUrl +'userId='+GetUrlParam( 'userId' )+'&Command=' + command ;

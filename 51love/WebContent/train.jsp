...
<div class="wrapper1250 cm_block01">
    <div class="block01">
        ...
        <ul>
            ...
            <li><a href="train.jsp?id=1773368"  id="qsxl0" target="_self"   <%="1773368".equals(id)?"class='current'":""%>>训练介绍</a></li>
            <li><a href="train.jsp?id=1773369"  id="qsxl1" target="_self"  <%="1773369".equals(id)?"class='current'":""%>>训练图片</a></li>
            <li><a href="trainshare.jsp"  id="qsxl2" target="_self" >训练分享</a></li>
        </ul>
    </div>
    <div class="block02">
        <div class="lm_name">

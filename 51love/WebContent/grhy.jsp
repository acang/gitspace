  ...
  <div class="block01">
    ...
    <div class="box02">
      ...
      <div class="tab" id="personTab">
          <span class="current" onClick="selectTagHy('pertagContent0',this)" onmouseover="changeClass(this)" onmouseout="recoverClass(this)">好友申请</span>
          <span onClick="selectTagHy('pertagContent1',this)" onmouseover="changeClass(this)" onmouseout="recoverClass(this)">好友名单</span>
          <span onClick="selectTagHy('pertagContent2',this)" onmouseover="changeClass(this)" onmouseout="recoverClass(this)">黑名单</span></div>
      <div class="mingdan show" id="pertagContent0">
          <iframe width="100%" height="670px" src="hysq.jsp" name="hysq_frame" frameborder="0"></iframe>

      </div>
      <div class="mingdan" id="pertagContent1">
          <iframe width="100%" height="670px" src="hymd.jsp" name="hysq_frame" frameborder="0" ></iframe>

      </div>
      <div class="mingdan"  id="pertagContent2">
          <iframe width="100%" height="670px" src="hmd.jsp" name="hysq_frame" frameborder="0"></iframe>

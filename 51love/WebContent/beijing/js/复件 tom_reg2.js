...
case "中国"://中国
	...
	case "海南"://海南
		...
		subTypeForm.options[2]=new Option("海南其它","海南其它");
		subTypeForm.options[0].selected=true;
		break;
	case "福建"://福建
	...
	case "湖北"://湖北
		...
		//subTypeForm.options[13]=new Option("湖北其它","湖北其它");
		subTypeForm.options[0].selected=true;
		break;
	case "河南"://河南
		...
		subTypeForm.options[17]=new Option("河南其它","河南其它");
		subTypeForm.options[0].selected=true;
		break;
	case "河北"://河北
	...
	case "辽宁"://辽宁
		...
		break;
	case "上海"://上海
		subTypeForm.options[0]=new Option("黄埔区","黄埔区");
		...
		subTypeForm.options[15]=new Option("清浦区","清浦区");
